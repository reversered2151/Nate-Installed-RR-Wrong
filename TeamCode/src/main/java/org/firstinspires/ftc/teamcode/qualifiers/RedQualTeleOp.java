...
public class RedQualTeleOp extends LinearOpMode {
    ...
    private static final double VELOCITY_REDUCTION = 40.0;  // Reduce velocity by 40 after first second
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()){
            ...
            if (gamepad1.dpad_up) {
                ...
                telemetry.addData("Red Center Override", "(0, 0, 0)");
                telemetry.update();
                sleep(300); // Debounce
            }
...
//            telemetry.addData("Goal Y", goalY);
     ...
     */
    private boolean isFlywheelAtSpeed(double targetVelocity) {
        double currentRpm = ticksPerSecToRpm(flywheel.getVelocity());
        return Math.abs(currentRpm - targetVelocity) <= SPEED_TOL_RPM;
    }

    private boolean isFlywheelAtSpeedNEW(double targetVelocity) {
